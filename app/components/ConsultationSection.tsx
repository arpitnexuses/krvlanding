    ...
    <section className="w-full pt-8 pb-0 md:pt-8 md:pb-0 bg-gray-50">
      <div className="max-w-[1200px] mx-auto px-4">
        <div className="text-center mb-8 md:mb-16 pt-4 md:pt-8">
          <h2 className="text-[24px] md:text-[32px] font-semibold text-[#1D2939] max-w-[600px] mx-auto leading-tight px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-0">
          ...
          <div className="relative overflow-hidden h-[400px] md:h-[300px] bg-[#F5F5F5]">
            <div className="grid grid-cols-1 md:grid-cols-2 h-full">
              {/* Left side - Image */}
              <div className="relative h-[200px] md:h-full opacity-90">
              ...
              {/* Right side - Content */}
              <div className="p-4 md:p-8 flex flex-col justify-center relative z-20">
                <h3 className="text-xl md:text-2xl font-semibold text-[#1D2939] mb-2">
                  Free Consultation
                </h3>
                <p className="text-xs md:text-sm text-[#475467] mb-4">
                ...
                <Link 
                  ...
                  className="bg-[#01445E] text-white px-4 md:px-5 py-2 rounded-lg inline-flex items-center gap-2 hover:bg-[#013348] transition-all duration-300 hover:scale-105 hover:shadow-lg w-fit text-xs md:text-sm group"
                >
                  <span>Book Now</span>
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-black/50 via-black/50 to-black/50 p-8 flex flex-col justify-center items-center">
              <div className="max-w-[300px] text-center px-4">
                ...
                <Link 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white text-[#1D2939] px-4 md:px-5 py-2 rounded-lg inline-flex items-center gap-2 hover:bg-gray-100 transition-all duration-300 hover:scale-105 hover:shadow-lg w-fit text-xs md:text-sm group mx-auto"
                >
